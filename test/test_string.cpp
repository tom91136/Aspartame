...
TEST_CASE("trim_leading", "[" TPE_NAME "][" TPE_GROUP "]") {
...
TEST_CASE("trim_trailing", "[" TPE_NAME "][" TPE_GROUP "]") {
...
#ifndef DISABLE_TRIM
TEST_CASE("trim", "[" TPE_NAME "][" TPE_GROUP "]") {
...
TEST_CASE("is_blank", "[" TPE_NAME "][" TPE_GROUP "]") {
  CHECK(("" | is_blank()) == true);
  CHECK(("     " | is_blank()) == true);
...
TEST_CASE("indent", "[" TPE_NAME "][" TPE_GROUP "]") {
...
TEST_CASE("to_upper", "[" TPE_NAME "][" TPE_GROUP "]") {
...
TEST_CASE("to_lower", "[" TPE_NAME "][" TPE_GROUP "]") {
...
TEST_CASE("replace_all", "[" TPE_NAME "][" TPE_GROUP "]") {
...
TEST_CASE("contains_ignore_case", "[" TPE_NAME "][" TPE_GROUP "]") {
...
TEST_CASE("equals_ignore_case", "[" TPE_NAME "][" TPE_GROUP "]") {
...
TEST_CASE("split", "[" TPE_NAME "][" TPE_GROUP "]") {
...
TEST_CASE("lines", "[" TPE_NAME "][" TPE_GROUP "]") {
