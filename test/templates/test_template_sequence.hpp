...
TEST_CASE(TPE_NAME "_contains_slice", "[" TPE_NAME "][" TPE_GROUP "]") {
  ...
  RUN_CHECK(Foo, bool, "", {Foo(3), Foo(2), Foo(1)}, true, [](auto xs) { return xs OP_ contains_slice(TPE_CTOR_IN(Foo){Foo(3), Foo(2)}); });
  RUN_CHECK(Foo, bool, "", {Foo(3), Foo(2), Foo(1)}, true, [](auto xs) { return xs OP_ contains_slice(TPE_CTOR_IN(Foo){Foo(2), Foo(1)}); });
