...
TEST_CASE("prepend", "[" TPE_NAME "][" TPE_GROUP "]") {
  auto prependOp = [](auto &&x) { return [&](auto xs) { return xs | prepend(std::forward<decltype(x)>(x)); }; };
  #ifdef TPE_MANY_INIT
...
TEST_CASE("head_maybe", "[" TPE_NAME "][" TPE_GROUP "]") {
  auto reverseOp = [](auto xs) { return xs | head_maybe(); };
...
TEST_CASE("last_maybe", "[" TPE_NAME "][" TPE_GROUP "]") {
  auto reverseOp = [](auto xs) { return xs | last_maybe(); };
...
#ifndef DISABLE_INIT
TEST_CASE("init", "[" TPE_NAME "][" TPE_GROUP "]") {
  auto initOp = [](auto xs) { return xs | init(); };
  #ifdef TPE_MANY_INIT
...
#ifndef DISABLE_TAIL
TEST_CASE("tail", "[" TPE_NAME "][" TPE_GROUP "]") {
  auto tailOp = [](auto xs) { return xs | tail(); };
  #ifdef TPE_MANY_INIT
...
TEST_CASE("at_maybe", "[" TPE_NAME "][" TPE_GROUP "]") {
  auto at0Op = [](auto xs) { return xs | at_maybe(0); };
  auto at1Op = [](auto xs) { return xs | at_maybe(1); };
  auto at100Op = [](auto xs) { return xs | at_maybe(100); };
...
TEST_CASE("slice", "[" TPE_NAME "][" TPE_GROUP "]") {
...
TEST_CASE("index_of_slice", "[" TPE_NAME "][" TPE_GROUP "]") {
  #ifdef TPE_MANY_INIT
  RUN_CHECK(int, long, "", {4, 2, 3, 1, 5}, 0, [](auto xs) { return xs | index_of_slice(TPE_CTOR_IN(int){4, 2}); });
  RUN_CHECK(int, long, "", {4, 2, 3, 1, 5}, 2, [](auto xs) { return xs | index_of_slice(TPE_CTOR_IN(int){3, 1}); });
  RUN_CHECK(int, long, "", {4, 2, 3, 1, 5}, -1, [](auto xs) { return xs | index_of_slice(TPE_CTOR_IN(int){1, 2}); });
  RUN_CHECK(int, long, "", {4, 2, 3, 1, 5}, -1, [](auto xs) { return xs | index_of_slice(TPE_CTOR_IN(int){6}); });
  RUN_CHECK(string, long, "", {"banana", "cherry", "apple"}, 0, [](auto xs) {
    return xs | index_of_slice(TPE_CTOR_IN(string){"banana", "cherry"});
  });
  RUN_CHECK(string, long, "", {"banana", "cherry", "apple"}, 1, [](auto xs) {
    return xs | index_of_slice(TPE_CTOR_IN(string){"cherry", "apple"});
  });
  RUN_CHECK(string, long, "", {"banana", "cherry", "apple"}, -1, [](auto xs) {
    return xs | index_of_slice(TPE_CTOR_IN(string){"apple", "banana"});
  });
  RUN_CHECK(string, long, "", {"banana", "cherry", "apple"}, -1, [](auto xs) { return xs | index_of_slice(TPE_CTOR_IN(string){"pear"}); });
  RUN_CHECK(Foo, long, "", {Foo(3), Foo(2), Foo(1)}, 0, [](auto xs) { return xs | index_of_slice(TPE_CTOR_IN(Foo){Foo(3), Foo(2)}); });
  RUN_CHECK(Foo, long, "", {Foo(3), Foo(2), Foo(1)}, 1, [](auto xs) { return xs | index_of_slice(TPE_CTOR_IN(Foo){Foo(2), Foo(1)}); });
  RUN_CHECK(Foo, long, "", {Foo(3), Foo(2), Foo(1)}, -1, [](auto xs) { return xs | index_of_slice(TPE_CTOR_IN(Foo){Foo(1), Foo(3)}); });
  RUN_CHECK(Foo, long, "", {Foo(3), Foo(2), Foo(1)}, -1, [](auto xs) { return xs | index_of_slice(TPE_CTOR_IN(Foo){Foo(4)}); });
  #endif

  RUN_CHECK(int, long, "", {6}, 0, [](auto xs) { return xs | index_of_slice(TPE_CTOR_IN(int){6}); });
  RUN_CHECK(int, long, "", {5}, -1, [](auto xs) { return xs | index_of_slice(TPE_CTOR_IN(int){6}); });
  RUN_CHECK(int, long, "", {}, -1, [](auto xs) { return xs | index_of_slice(TPE_CTOR_IN(int){6}); });

  RUN_CHECK(string, long, "", {"banana"}, -1, [](auto xs) { return xs | index_of_slice(TPE_CTOR_IN(string){"pear"}); });
  RUN_CHECK(string, long, "", {"banana"}, 0, [](auto xs) { return xs | index_of_slice(TPE_CTOR_IN(string){"banana"}); });
  RUN_CHECK(string, long, "", {}, -1, [](auto xs) { return xs | index_of_slice(TPE_CTOR_IN(string){"pear"}); });

  RUN_CHECK(Foo, long, "", {Foo(3)}, -1, [](auto xs) { return xs | index_of_slice(TPE_CTOR_IN(Foo){Foo(4)}); });
  RUN_CHECK(Foo, long, "", {Foo(4)}, 0, [](auto xs) { return xs | index_of_slice(TPE_CTOR_IN(Foo){Foo(4)}); });
  RUN_CHECK(Foo, long, "", {}, -1, [](auto xs) { return xs | index_of_slice(TPE_CTOR_IN(Foo){Foo(4)}); });
}
#endif

#ifndef DISABLE_CONTAINS_SLICE
TEST_CASE("contains_slice", "[" TPE_NAME "][" TPE_GROUP "]") {
  #ifdef TPE_MANY_INIT
  RUN_CHECK(int, bool, "", {4, 2, 3, 1, 5}, true, [](auto xs) { return xs | contains_slice(TPE_CTOR_IN(int){4, 2}); });
  RUN_CHECK(int, bool, "", {4, 2, 3, 1, 5}, true, [](auto xs) { return xs | contains_slice(TPE_CTOR_IN(int){3, 1}); });
  RUN_CHECK(int, bool, "", {4, 2, 3, 1, 5}, false, [](auto xs) { return xs | contains_slice(TPE_CTOR_IN(int){1, 2}); });
  RUN_CHECK(int, bool, "", {4, 2, 3, 1, 5}, false, [](auto xs) { return xs | contains_slice(TPE_CTOR_IN(int){6}); });
  RUN_CHECK(string, bool, "", {"banana", "cherry", "apple"}, true, [](auto xs) {
    return xs | contains_slice(TPE_CTOR_IN(string){"banana", "cherry"});
  });
  RUN_CHECK(string, bool, "", {"banana", "cherry", "apple"}, true, [](auto xs) {
    return xs | contains_slice(TPE_CTOR_IN(string){"cherry", "apple"});
  });
  RUN_CHECK(string, bool, "", {"banana", "cherry", "apple"}, false, [](auto xs) {
    return xs | contains_slice(TPE_CTOR_IN(string){"apple", "banana"});
  });
  RUN_CHECK(string, bool, "", {"banana", "cherry", "apple"}, false, [](auto xs) { return xs | contains_slice(TPE_CTOR_IN(string){"pear"}); });
  RUN_CHECK(Foo, bool, "", {Foo(3), Foo(2), Foo(1)}, true, [](auto xs) { return xs | contains_slice(TPE_CTOR_IN(Foo){Foo(3), Foo(2)}); });
  RUN_CHECK(Foo, bool, "", {Foo(3), Foo(2), Foo(1)}, true, [](auto xs) { return xs | contains_slice(TPE_CTOR_IN(Foo){Foo(2), Foo(1)}); });
  RUN_CHECK(Foo, bool, "", {Foo(3), Foo(2), Foo(1)}, false, [](auto xs) { return xs | contains_slice(TPE_CTOR_IN(Foo){Foo(1), Foo(3)}); });
  RUN_CHECK(Foo, bool, "", {Foo(3), Foo(2), Foo(1)}, false, [](auto xs) { return xs | contains_slice(TPE_CTOR_IN(Foo){Foo(4)}); });
  #endif

  RUN_CHECK(int, bool, "", {6}, true, [](auto xs) { return xs | contains_slice(TPE_CTOR_IN(int){6}); });
  RUN_CHECK(int, bool, "", {5}, false, [](auto xs) { return xs | contains_slice(TPE_CTOR_IN(int){6}); });
  RUN_CHECK(int, bool, "", {}, false, [](auto xs) { return xs | contains_slice(TPE_CTOR_IN(int){6}); });

  RUN_CHECK(string, bool, "", {"banana"}, false, [](auto xs) { return xs | contains_slice(TPE_CTOR_IN(string){"pear"}); });
  RUN_CHECK(string, bool, "", {"banana"}, true, [](auto xs) { return xs | contains_slice(TPE_CTOR_IN(string){"banana"}); });
  RUN_CHECK(string, bool, "", {}, false, [](auto xs) { return xs | contains_slice(TPE_CTOR_IN(string){"pear"}); });

  RUN_CHECK(Foo, bool, "", {Foo(3)}, false, [](auto xs) { return xs | contains_slice(TPE_CTOR_IN(Foo){Foo(4)}); });
  RUN_CHECK(Foo, bool, "", {Foo(4)}, true, [](auto xs) { return xs | contains_slice(TPE_CTOR_IN(Foo){Foo(4)}); });
  RUN_CHECK(Foo, bool, "", {}, false, [](auto xs) { return xs | contains_slice(TPE_CTOR_IN(Foo){Foo(4)}); });
}
#endif

#ifndef DISABLE_INDEX_OF
TEST_CASE("index_of", "[" TPE_NAME "][" TPE_GROUP "]") {
  RUN_CHECK(int, long, "", {4, 2, 3, 1, 5}, 0, [](auto xs) { return xs | index_of(4); });
  RUN_CHECK(int, long, "", {1}, 0, [](auto xs) { return xs | index_of(1); });
  RUN_CHECK(int, long, "", {1}, -1, [](auto xs) { return xs | index_of(0); });
  RUN_CHECK(int, long, "", {}, -1, [](auto xs) { return xs | index_of(1); });

  RUN_CHECK(string, long, "", {"banana", "cherry", "apple"}, 0, [](auto xs) { return xs | index_of("banana"); });
  RUN_CHECK(string, long, "", {"apple"}, 0, [](auto xs) { return xs | index_of("apple"); });
  RUN_CHECK(string, long, "", {"apple"}, -1, [](auto xs) { return xs | index_of("banana"); });
  RUN_CHECK(string, long, "", {}, -1, [](auto xs) { return xs | index_of("apple"); });

  RUN_CHECK(Foo, long, "", {Foo(3), Foo(2), Foo(1)}, 0, [](auto xs) { return xs | index_of(Foo(3)); });
  RUN_CHECK(Foo, long, "", {Foo(1)}, 0, [](auto xs) { return xs | index_of(Foo(1)); });
  RUN_CHECK(Foo, long, "", {Foo(1)}, -1, [](auto xs) { return xs | index_of(Foo(2)); });
  RUN_CHECK(Foo, long, "", {}, -1, [](auto xs) { return xs | index_of(Foo(1)); });
}
#endif

#ifndef DISABLE_CONTAINS
TEST_CASE("contains", "[" TPE_NAME "][" TPE_GROUP "]") {
  RUN_CHECK(int, bool, "", {4, 2, 3, 1, 5}, true, [](auto xs) { return xs | contains(4); });
  RUN_CHECK(int, bool, "", {1}, true, [](auto xs) { return xs | contains(1); });
  RUN_CHECK(int, bool, "", {1}, false, [](auto xs) { return xs | contains(0); });
  RUN_CHECK(int, bool, "", {}, false, [](auto xs) { return xs | contains(1); });

  RUN_CHECK(string, bool, "", {"banana", "cherry", "apple"}, true, [](auto xs) { return xs | contains("banana"); });
  RUN_CHECK(string, bool, "", {"apple"}, true, [](auto xs) { return xs | contains("apple"); });
  RUN_CHECK(string, bool, "", {"apple"}, false, [](auto xs) { return xs | contains("banana"); });
  RUN_CHECK(string, bool, "", {}, false, [](auto xs) { return xs | contains("apple"); });

  RUN_CHECK(Foo, bool, "", {Foo(3), Foo(2), Foo(1)}, true, [](auto xs) { return xs | contains(Foo(3)); });
  RUN_CHECK(Foo, bool, "", {Foo(1)}, true, [](auto xs) { return xs | contains(Foo(1)); });
  RUN_CHECK(Foo, bool, "", {Foo(1)}, false, [](auto xs) { return xs | contains(Foo(2)); });
  RUN_CHECK(Foo, bool, "", {}, false, [](auto xs) { return xs | contains(Foo(1)); });
}
#endif

#ifndef DISABLE_INDEX_WHERE
TEST_CASE("index_where", "[" TPE_NAME "][" TPE_GROUP "]") {
  RUN_CHECK(int, long, "", {4, 2, 3, 1, 5}, 0, [](auto xs) { return xs | index_where([](auto x) { return x == 4; }); });
  RUN_CHECK(int, long, "", {1}, 0, [](auto xs) { return xs | index_where([](auto x) { return x == 1; }); });
  RUN_CHECK(int, long, "", {1}, -1, [](auto xs) { return xs | index_where([](auto x) { return x == 0; }); });
  RUN_CHECK(int, long, "", {}, -1, [](auto xs) { return xs | index_where([](auto x) { return x == 1; }); });

  RUN_CHECK(string, long, "", {"banana", "cherry", "apple"}, 0,
            [](auto xs) { return xs | index_where([](auto x) { return x == "banana"; }); });
  RUN_CHECK(string, long, "", {"apple"}, 0, [](auto xs) { return xs | index_where([](auto x) { return x == "apple"; }); });
  RUN_CHECK(string, long, "", {"apple"}, -1, [](auto xs) { return xs | index_where([](auto x) { return x == "banana"; }); });
  RUN_CHECK(string, long, "", {}, -1, [](auto xs) { return xs | index_where([](auto x) { return x == "apple"; }); });

  RUN_CHECK(Foo, long, "", {Foo(3), Foo(2), Foo(1)}, 0, [](auto xs) { return xs | index_where([](auto x) { return x == Foo(3); }); });
  RUN_CHECK(Foo, long, "", {Foo(1)}, 0, [](auto xs) { return xs | index_where([](auto x) { return x == Foo(1); }); });
  RUN_CHECK(Foo, long, "", {Foo(1)}, -1, [](auto xs) { return xs | index_where([](auto x) { return x == Foo(2); }); });
  RUN_CHECK(Foo, long, "", {}, -1, [](auto xs) { return xs | index_where([](auto x) { return x == Foo(1); }); });

  auto p2 = [](auto name, auto f) {
    using P2 = std::pair<int, int>;
  #ifdef TPE_MANY_INIT
    RUN_CHECK(P2, long, name, {{3, 1}, {2, 2}, {1, 3}}, 1, f);
  #endif
    RUN_CHECK(P2, long, name, {{3, 1}}, -1, f);
    RUN_CHECK(P2, long, name, {}, -1, f);
  };
  p2("spread", [](auto xs) { return xs | index_where([](auto x0, auto x1) { return x0 == x1; }); });
  p2("single", [](auto xs) { return xs | index_where([](auto x) { return get<0>(x) == get<1>(x); }); });

  auto p3 = [](auto name, auto f) {
    using P3 = std::tuple<int, int, int>;
  #ifdef TPE_MANY_INIT
    RUN_CHECK(P3, long, name, {{3, 1, 3}, {2, 2, 2}, {1, 3, 1}}, 1, f);
  #endif
    RUN_CHECK(P3, long, name, {{3, 1, 3}}, -1, f);
    RUN_CHECK(P3, long, name, {}, -1, f);
  };
  p3("spread", [](auto xs) { return xs | index_where([](auto x0, auto x1, auto x2) { return x0 == x1 && x1 == x2; }); });
  p3("single", [](auto xs) { return xs | index_where([](auto x) { return get<0>(x) == get<1>(x) && get<1>(x) == get<2>(x); }); });
}
#endif

#ifndef DISABLE_ZIP_WITH_INDEX
TEST_CASE("zip_with_index", "[" TPE_NAME "][" TPE_GROUP "]") {
  ...
  auto zipIdxOp = [](auto xs) { return xs | zip_with_index(); };
...
#ifndef DISABLE_ZIP
TEST_CASE("zip", "[" TPE_NAME "][" TPE_GROUP "]") {
  ...
  auto zipOp = [](auto &&ys) { return [&](auto xs) { return xs | zip(ys); }; };
...
TEST_CASE("transpose", "[" TPE_NAME "][" TPE_GROUP "]") {

  auto transposeOp = [](auto xs) { return xs | transpose(); };
...
TEST_CASE("reverse", "[" TPE_NAME "][" TPE_GROUP "]") {
  auto reverseOp = [](auto xs) { return xs | reverse(); };
  #ifdef TPE_MANY_INIT
...
TEST_CASE("shuffle", "[" TPE_NAME "][" TPE_GROUP "]") {
...
#ifndef DISABLE_SORT
TEST_CASE("sort", "[" TPE_NAME "][" TPE_GROUP "]") {
  auto sortOp = [](auto xs) { return xs | sort(); };
  #ifdef TPE_MANY_INIT
  ...
  auto sortCustomCmpOp = [](auto xs) { return xs | sort(std::greater<>()); };
  #ifdef TPE_MANY_INIT
...
TEST_CASE("sort_by", "[" TPE_NAME "][" TPE_GROUP "]") {
...
TEST_CASE("split_at", "[" TPE_NAME "][" TPE_GROUP "]") {
  auto splitAtOpInt = [](size_t idx) { return [=](auto xs) { return xs | split_at(idx); }; };
  auto splitAtOpString = [](size_t idx) { return [=](auto xs) { return xs | split_at(idx); }; };
  auto splitAtOpFoo = [](size_t idx) { return [=](auto xs) { return xs | split_at(idx); }; };
...
#ifndef DISABLE_TAKE
TEST_CASE("take", "[" TPE_NAME "][" TPE_GROUP "]") {
  auto take3 = [](auto xs) { return xs | take(3); };
  #ifdef TPE_MANY_INIT
  ...
  auto take0 = [](auto xs) { return xs | take(0); };
  #ifdef TPE_MANY_INIT
...
#ifndef DISABLE_DROP
TEST_CASE("drop", "[" TPE_NAME "][" TPE_GROUP "]") {
  auto drop3 = [](auto xs) { return xs | drop(3); };
  ...
  auto drop0 = [](auto xs) { return xs | drop(0); };
  #ifdef TPE_MANY_INIT
...
TEST_CASE("take_right", "[" TPE_NAME "][" TPE_GROUP "]") {
  auto takeRight3 = [](auto xs) { return xs | take_right(3); };
  #ifdef TPE_MANY_INIT
  ...
  auto takeRight0 = [](auto xs) { return xs | take_right(0); };
  #ifdef TPE_MANY_INIT
...
TEST_CASE("drop_right", "[" TPE_NAME "][" TPE_GROUP "]") {
  auto dropRight3 = [](auto xs) { return xs | drop_right(3); };
  ...
  auto dropRight0 = [](auto xs) { return xs | drop_right(0); };
  #ifdef TPE_MANY_INIT
...
TEST_CASE("take_while", "[" TPE_NAME "][" TPE_GROUP "]") {
  auto intTakeOp = [](auto xs) { return xs | take_while([](auto x) { return x < 3; }); };
  auto stringTakeOp = [](auto xs) { return xs | take_while([](auto x) { return x.size() < 3; }); };
  auto fooTakeOp = [](auto xs) { return xs | take_while([](auto x) { return x.value < 3; }); };
  ...
  p2("spread", [](auto xs) { return xs | take_while([](auto x0, auto x1) { return x0 == x1; }); });
  p2("single", [](auto xs) { return xs | take_while([](auto x) { return get<0>(x) == get<1>(x); }); });
  ...
  p3("spread", [](auto xs) { return xs | take_while([](auto x0, auto x1, auto x2) { return x0 == x1 && x1 == x2; }); });
  p3("single", [](auto xs) { return xs | take_while([](auto x) { return get<0>(x) == get<1>(x) && get<1>(x) == get<2>(x); }); });
}
#endif

#ifndef DISABLE_DROP_WHILE
TEST_CASE("drop_while", "[" TPE_NAME "][" TPE_GROUP "]") {
  auto intTakeOp = [](auto xs) { return xs | drop_while([](auto x) { return x < 3; }); };
  auto stringTakeOp = [](auto xs) { return xs | drop_while([](auto x) { return x.size() < 3; }); };
  auto fooTakeOp = [](auto xs) { return xs | drop_while([](auto x) { return x.value < 3; }); };
  ...
  p2("spread", [](auto xs) { return xs | drop_while([](auto x0, auto x1) { return x0 == x1; }); });
  p2("single", [](auto xs) { return xs | drop_while([](auto x) { return get<0>(x) == get<1>(x); }); });
  ...
  p3("spread", [](auto xs) { return xs | drop_while([](auto x0, auto x1, auto x2) { return x0 == x1 && x1 == x2; }); });
  p3("single", [](auto xs) { return xs | drop_while([](auto x) { return get<0>(x) == get<1>(x) && get<1>(x) == get<2>(x); }); });
}
#endif

#ifndef DISABLE_FOLD_LEFT
TEST_CASE("fold_left", "[" TPE_NAME "][" TPE_GROUP "]") {
  auto foldLeftOpInt = [](auto xs) {
    return xs | fold_left(std::pair{0, 0}, [](auto a, auto x) { return std::pair{a.first + x, a.second + 1}; });
  };
  auto foldLeftOpString = [](auto xs) {
    return xs | fold_left(std::pair{std::string(""), 0}, [](auto a, auto x) { return std::pair{a.first + x, a.second + 1}; });
  };
  auto foldLeftOpFoo = [](auto xs) {
    return xs | fold_left(std::pair{Foo(0), 0}, [](auto a, auto x) { return std::pair{Foo(a.first.value + x.value), a.second + 1}; });
  };
...
TEST_CASE("fold_right", "[" TPE_NAME "][" TPE_GROUP "]") {
  auto foldRightOpInt = [](auto xs) {
    return xs | fold_right(std::pair{0, 0}, [](auto x, auto a) { return std::pair{x + a.first, a.second + 1}; });
  };
  auto foldRightOpString = [](auto xs) {
    return xs | fold_right(std::pair{std::string(""), 0}, [](auto x, auto a) { return std::pair{x + a.first, a.second + 1}; });
  };
  auto foldRightOpFoo = [](auto xs) {
    return xs | fold_right(std::pair{Foo(0), 0}, [](auto x, auto a) { return std::pair{Foo(x.value + a.first.value), a.second + 1}; });
  };
...
TEST_CASE("sliding", "[" TPE_NAME "][" TPE_GROUP "]") {
  auto slidingOpInt = [](size_t size, size_t step) { return [=](auto xs) { return xs | sliding(size, step); }; };
  auto slidingOpString = [](size_t size, size_t step) { return [=](auto xs) { return xs | sliding(size, step); }; };
  auto slidingOpFoo = [](size_t size, size_t step) { return [=](auto xs) { return xs | sliding(size, step); }; };
...
TEST_CASE("grouped", "[" TPE_NAME "][" TPE_GROUP "]") {
  auto slidingOpInt = [](size_t size) { return [=](auto xs) { return xs | grouped(size); }; };
  auto slidingOpString = [](size_t size) { return [=](auto xs) { return xs | grouped(size); }; };
  auto slidingOpFoo = [](size_t size) { return [=](auto xs) { return xs | grouped(size); }; };
